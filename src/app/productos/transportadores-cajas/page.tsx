...
const productData = {
  title: 'Transportador de Cajas / Packs',
  description: 'Nuestro transportador de cajas / packs está diseñado para optimizar el movimiento de productos en las Líneas de producción. Su objetivo es optimizar el flujo interno, mejorar la eficiencia y reducir la manipulación manual.\n\nFabricado con estructura modular en acero inoxidable, garantiza una alta durabilidad.',
  sliderItems: [
    { type: 'video' as const, src: '/videos/cajas-hero.mp4', alt: 'Transportador de cajas Ferdiale - Vista general' },
    { type: 'image' as const, src: '/images/cajas-slider-1.jpg', alt: 'Transportador de cajas Ferdiale - Detalle del sistema' },
    { type: 'video' as const, src: '/videos/cajas-slider-2.mp4', alt: 'Transportador de cajas Ferdiale - En funcionamiento' },
    { type: 'image' as const, src: '/images/cajas-slider-3.jpg', alt: 'Transportador de cajas Ferdiale - Estructura modular' },
    { type: 'image' as const, src: '/images/cajas-slider-4.jpg', alt: 'Transportador de cajas Ferdiale - Línea de producción' },
  ],
  enQueConsiste: {
    paragraphs: [
      'Cuenta con mallas modulares, velocidad regulable y capacidad para adaptarse a diferentes tamaños y pesos de cajas o packs. Su diseño facilita la limpieza y el mantenimiento, reduciendo tiempos de parada y aumentando la eficiencia operativa.',
      'Gracias a su diseño y componentes utilizados, se consiguen instalaciones con mantenimientos prácticamente inexistentes.',
    ],
  },
  porQueFerdiale: [
...
export default function TransportadoresCajas() {
    ...
    <main className="min-h-screen bg-white">
      ...
      >
        ...
        <video
          ...
          aria-hidden="true"
        >
          <source src="/videos/product-cajas.mp4" type="video/mp4" />
        </video>
