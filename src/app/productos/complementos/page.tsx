...
const productData = {
  title: 'Complementos',
  sliderItems: [
    { type: 'image' as const, src: '/images/complementos-hero.jpg', alt: 'Complementos Ferdiale - Vista general' },
    { type: 'image' as const, src: '/images/complementos-slider-1.png', alt: 'Complementos Ferdiale - Cubierta transportador' },
    { type: 'image' as const, src: '/images/complementos-slider-2.jpg', alt: 'Complementos Ferdiale - Sistema expulsor' },
    { type: 'image' as const, src: '/images/complementos-slider-3.jpg', alt: 'Complementos Ferdiale - Detalle componente' },
    { type: 'image' as const, src: '/images/complementos-slider-4.jpg', alt: 'Complementos Ferdiale - Omega' },
    { type: 'image' as const, src: '/images/complementos-slider-5.jpg', alt: 'Complementos Ferdiale - Mesa rechazo' },
  ],
  cubiertasContent: {
    paragraphs: [
      'Las cubiertas para transportadores son soluciones diseñadas para proteger los productos durante su desplazamiento en las líneas de producción.',
      'En sectores como la industria alimentaria, de bebidas y farmacéutica, estas cubiertas industriales garantizan una protección eficaz frente a la contaminación, el polvo y las partículas externas, asegurando altos estándares de higiene y calidad. Además, mejoran la seguridad de los operarios y contribuyen a una mayor eficiencia y limpieza en la Línea de envasado.',
      'Fabricadas en acero inoxidable, aluminio o policarbonato, pueden adaptarse a distintos tipos de transportadores y diseñarse a medida según las necesidades del cliente.',
    ],
    items: [
      'Expulsor de envases caídos',
      'Omega',
      'Acumulación calles',
      'Mesa rechazo',
    ],
              ...
              >
                ...
                <article className="mb-12 lg:mb-16">
                  ...
                  <div className="text-text text-[16px] leading-[22px] space-y-4 mb-5">
                    {productData.cubiertasContent.paragraphs.map((paragraph, index) => (
                      <p key={index}>{paragraph}</p>
                    ))}
                  </div>
                  <ul className="text-text text-[16px] leading-[40px] list-disc pl-6">
                    {productData.cubiertasContent.items.map((item, index) => (
