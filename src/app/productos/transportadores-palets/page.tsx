...
const productData = {
  ...
  description: 'El transportador de palets está diseñado para optimizar el flujo de materiales en líneas de producción, garantizando movimientos precisos, seguros y continuos de productos o contenedores.\n\nSu estructura robusta ofrece una alta durabilidad, permitiendo el manejo de cargas pesadas sin comprometer la estabilidad ni el rendimiento.',
  sliderItems: [
    { type: 'image' as const, src: '/images/palets-hero.jpg', alt: 'Transportador de palets Ferdiale - Vista general' },
    { type: 'image' as const, src: '/images/palets-slider-1.png', alt: 'Transportador de palets Ferdiale - Detalle del sistema' },
    { type: 'image' as const, src: '/images/palets-slider-2.jpg', alt: 'Transportador de palets Ferdiale - Estructura robusta' },
    { type: 'image' as const, src: '/images/palets-slider-3.jpg', alt: 'Transportador de palets Ferdiale - Línea de producción' },
    { type: 'image' as const, src: '/images/palets-slider-4.jpg', alt: 'Transportador de palets Ferdiale - Sistema de transporte' },
  ],
  enQueConsiste: {
    paragraphs: [
      'Gracias a su diseño modular y adaptable, este sistema se integra fácilmente con equipos automáticos de paletización, envolvedoras y sistemas de control industrial, proporcionando una solución flexible que se ajusta a distintos formatos de línea y configuraciones de planta.',
      'El transportador combina eficiencia operativa y fiabilidad mecánica, reduciendo los tiempos de inactividad/mantenimiento y mejorando la productividad general del proceso de envasado. Su ingeniería precisa, y componentes de alta calidad, aseguran un funcionamiento silencioso, bajo mantenimiento y una larga vida útil.',
    ],
    boldClosing: 'Ideal para entornos industriales que exigen rendimiento continuo, seguridad y máxima eficiencia en la manipulación de palets.',
  },
  porQueFerdiale: [
...
export default function TransportadoresPalets() {
    ...
    <main className="min-h-screen bg-white">
        ...
        <div className="max-w-[1240px] mx-auto px-6 md:px-10 pt-12 md:pt-16 lg:pt-[80px]">
          ...
          <div className="flex flex-col lg:flex-row gap-8 lg:gap-12">
            ...
            >
              ...
              <p className="text-text text-[16px] leading-[22px] mb-6 lg:mb-8 whitespace-pre-line">
              ...
              >
                ...
                <article className="mb-12 lg:mb-16">
                  ...
                  <div className="text-text text-[16px] leading-[22px] space-y-4">
                    ...
                    <p className="font-bold">{productData.enQueConsiste.boldClosing}</p>
                  </div>
                </article>
      ...
      >
        ...
        <video
          ...
          aria-hidden="true"
        >
          <source src="/videos/product-envases.mp4" type="video/mp4" />
        </video>
