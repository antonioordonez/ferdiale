...
const productData = {
  ...
  enQueConsiste: {
    ...
    features: [
      { title: 'Diseño de estructura robusta', description: 'Estructura resistente que garantiza estabilidad y larga vida útil.' },
      { title: 'Sistema de transporte ajustable', description: 'Adaptabilidad total a distintos tipos y tamaños de envases.' },
      { title: 'Operación de flujo continuo', description: 'Flujo constante que evita interrupciones en la línea de producción.' },
      { title: 'Ingeniería de precisión', description: 'Movimiento suave y preciso para proteger los productos transportados.' },
      { title: 'Alta productividad', description: 'Mejora los tiempos de ciclo y reduce los cuellos de botella.' },
      { title: 'Bajo mantenimiento', description: 'Diseño eficiente para un mantenimiento rápido y sencillo.' },
    ],
  },
  porQueFerdiale: [
...
export default function TransportadoresEnvases() {
            ...
            <div className="flex flex-col lg:flex-row gap-10 lg:gap-16">
              ...
              >
                ...
                <article className="mb-12 lg:mb-16">
                  ...
                  <p className="text-text text-[16px] leading-[22px] mb-5">
                    {productData.enQueConsiste.intro}
                  </p>
                  <ul className="space-y-1" role="list">
                    {productData.enQueConsiste.features.map((feature, index) => (
                      <li key={index} className="text-text text-[16px] leading-[40px]">
